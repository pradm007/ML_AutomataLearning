...
class WhiteboxRNNCounterexampleGenerator:
    ...
    def _process_new_state_except_children(self,new_cluster,new_info):
        ...
        if not new_info.accepting == (new_info.dfa_state in self.proposed_dfa.accept_states):
    ...
    def _add_children_states(self,cluster):
        ...
        if not state_info.explored:
            ...
            for char in self.proposed_dfa.alphabet:
                ...
                next_dfa_state = self.proposed_dfa.transition(state_info.dfa_state, char)
    ...
    def _initialise_unrolling(self):
        ...
        self.new_RStates = [UnrollingInfo(self.proposed_dfa._start_state,"",initial_RState,pos)]
    ...
    def counterexample(self,dfa): 
        ...
        print("guided starting equivalence query for DFA of size " + str(len(dfa.states)))
