...
from architect.algorithms.passive.passive_learner import PassiveLearner
...
class RPNI(PassiveLearner):
    ...
    def __init__(self, pos_examples: Set[str], neg_examples: Set[str], alphabet: Set[str], teacher: Teacher):
        """
