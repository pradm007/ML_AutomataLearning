import copy
from architect import utils, automaton
...
class LSTAR(ActiveLearner):
    ...
    def learn(self) -> automaton.DFA:
        ...
        while True:
            ...
            print("New Lstar obs table refinement took " + str(int(1000 * (clock() - start)) / 1000.0))
            # answer, satisfied = self._oracle.equivalence_query(dfa)
            answer, satisfied = self._teacher.equivalence_query(dfa)
